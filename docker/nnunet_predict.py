...
import torch
from batchgenerators.utilities.file_and_folder_operations import isdir, join, save_json
...
def main():
    ...
    parser.add_argument(
        ...
        "--cascade_trainer_class_name (this part can be ignored if defaults are used)." % default_trainer,
        required=False,
    ...
    parser.add_argument(
        ...
        help="Trainer class name used for predicting the 3D full resolution U-Net part of the cascade. Default is %s" % default_cascade_trainer,
        required=False,
    ...
    parser.add_argument(
        ...
        nargs="+",
        default="None",
        help="folds to use for prediction. Default is None which means that folds will be detected automatically in the model output folder",
    )
    ...
    parser.add_argument(
        ...
        default=6,
        type=int,
        help="Determines many background processes will be used for data preprocessing. Reduce this if you run into out of memory (RAM) problems. Default: 6",
    )
    ...
    parser.add_argument(
        ...
        default=2,
        type=int,
        help="Determines many background processes will be used for segmentation export. Reduce this if you run into out of memory (RAM) problems. Default: 2",
    )
    ...
    parser.add_argument(
        ...
        default=False,
        action="store_true",
        help="set this flag to disable test time data augmentation via mirroring. Speeds up inference by roughly factor 4 (2D) or 8 (3D)",
    )
    ...
    if model == "3d_cascade_fullres" and lowres_segmentations is None:
        ...
        model_folder_name = join(network_training_output_dir, "3d_lowres", task_name, trainer_class_name + "__" + args.plans_identifier)
    ...
    shutil.copy("./labels.txt", join(output_folder, "labels.txt"))
